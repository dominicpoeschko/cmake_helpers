...
elseif("${USE_SANITIZER}" STREQUAL "fuzzer")
  ...
  message(
    FATAL_ERROR
    "invalid USE_SANITIZER ${USE_SANITIZER} for gcc"
  )
  endif()
elseif("${USE_SANITIZER}" STREQUAL "none")
  ...
  message(
    FATAL_ERROR
    "invalid USE_SANITIZER ${USE_SANITIZER} use none, address, thread or fuzzer"
  )
endif()
