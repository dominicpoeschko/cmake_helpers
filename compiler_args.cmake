...
elseif(("${CMAKE_BUILD_TYPE}" STREQUAL "Release") OR ("${CMAKE_BUILD_TYPE}" STREQUAL "Debug"))
    ...
    message(FATAL_ERROR "invalid CMAKE_BUILD_TYPE ${CMAKE_BUILD_TYPE} use Release or Debug")
endif()
...
if(USE_STRIP
   AND "${USE_SANITIZER}" STREQUAL "none"
    ...
    if("${CMAKE_BUILD_TYPE}" STREQUAL "Release")
        if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
            ...
            target_compile_options(
                ${target}
                ${scope}
                $<$<COMPILE_LANGUAGE:CXX>:${fastmath_flag}
                ${optimize_flag}
                ${tmp_lto_flag}
                ${native_flag}
                ${rtti_flag}
            ...
            target_compile_options(
                ${target}
                ${scope}
                $<$<COMPILE_LANGUAGE:C>:${fastmath_flag}
                ${optimize_flag}
                ${tmp_lto_flag}
                ${native_flag}
                -DNDEBUG>)
        ...
        if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
            ...
            target_compile_options(
                ...
                ${rtti_flag}
                -ggdb>)
            target_compile_options(${target} ${scope} $<$<COMPILE_LANGUAGE:C>:${fastmath_flag} ${optimize_flag}
                                   ${lto_flag} -ggdb>)
