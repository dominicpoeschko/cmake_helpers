...
function(target_add_optimizer_flags target scope)
  ...
  if("${CMAKE_BUILD_TYPE}" STREQUAL "Release")
    if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
        target_compile_options(${target} ${scope} $<$<COMPILE_LANGUAGE:CXX>:/02 -DNDEBUG>)
        target_compile_options(${target} ${scope} $<$<COMPILE_LANGUAGE:C>:/02 -DNDEBUG>)
    else()
        target_compile_options(${target} ${scope} $<$<COMPILE_LANGUAGE:CXX>:${fastmath_flag} ${optimize_flag} ${lto_flag} ${native_flag} ${rtti_flag} -DNDEBUG>)
        target_compile_options(${target} ${scope} $<$<COMPILE_LANGUAGE:C>:${fastmath_flag} ${optimize_flag} ${lto_flag} ${native_flag} -DNDEBUG>)
